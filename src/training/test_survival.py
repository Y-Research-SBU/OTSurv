...
parser.add_argument('--checkpoint_path', type=str, default="../result/exp_otsurv_train/BLCA_survival/k=0/TCGA_BLCA_overall_survival::PANTHER_default::feats_h5/TCGA_BLCA_overall_survival::PANTHER_default::feats_h5::25-02-05-02-43-17/s_checkpoint.pth")
...
# dataset / split args ###
parser.add_argument('--data_source', type=str, default="../data/tcga_blca/extracted_mag20x_patch256_fp/extracted-vit_large_patch16_224.dinov2.uni_mass100k/feats_h5",
                    help='manually specify the data source') # /your/data/path/feats_h5
parser.add_argument('--split_dir', type=str, default="survival/TCGA_BLCA_overall_survival_k=0",
